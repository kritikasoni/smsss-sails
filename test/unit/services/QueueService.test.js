...
describe('PriorityQueueCollectionTest', function() {
  ...
  describe('#clearAll()', function () {
    it('should pass', function (done) {
      ...
      let priorityQueueCollection = new PriorityQueueCollection();
      priorityQueueCollection.setCollection(collectionA);
      let queueRoom = new QueueRoomDTO(1,'OPD1',priorityQueueCollection);

      let priorityQueueCollection2 = new PriorityQueueCollection();
      priorityQueueCollection.setCollection(collectionB);
      let queueRoom2 = new QueueRoomDTO(2,'OPD2', priorityQueueCollection2);
      const queueService = QueueService.set
